...
// Triggered automatically when a Photon chat channel is first created
handlers.ChannelCreate = function (args) {
    log.debug("Channel created: " + args.ChannelName + " by: " + args.UserId);
};

// Triggered automatically when a Photon chat channel is destroyed
handlers.ChannelDestroy = function (args) {
    log.debug("Channel destroyed: " + args.ChannelName + " history: " + args.History);
};

// Triggered automatically when a Photon chat channel is subscribed
handlers.ChannelSubscribe = function (args) {
    log.debug("Channel subscribed: " + args.ChannelName + " by: " + args.UserId);
};

// Triggered automatically when a Photon chat channel is unsubscribed
handlers.ChannelUnsubscribe = function (args) {
    log.debug("Channel unsubscribed: " + args.ChannelName + " by: " + args.UserId);
};

// Triggered automatically when a message is sent
handlers.PublishMessage = function (args) {
	if(args.ChannelType !== "Private") {    
		log.debug("Channel " + args.ChannelName + " message by: " + args.UserId + ":" + args.Message);
	} else {
        log.debug("Private message: " + args.UsersPairs[0] + " say " + args.Message + " to " + args.UsersPairs[1]);
    }
};
